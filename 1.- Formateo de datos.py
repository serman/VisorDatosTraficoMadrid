...
datos_i=open(ruta_archivo, "r")

vuelta=0 #contador de vueltas, lo inicializamos a 0, lo utilizaremos para que no nos genere una línea vacía al inicio del archivo
...
for j in datos_i:
	...
	vuelta+=1 #actualizamos el contador de vueltas
